...
var _mediaFeatureColonSpaceChecker = _interopRequireDefault(require("../mediaFeatureColonSpaceChecker.js"));
...
var ruleName = exports.ruleName = "media-feature-colon-space-before";
...
var rule = function rule(primary, _secondaryOptions, context) {
  ...
  return function (root, result) {
    ...
    var fixData;
    (0, _mediaFeatureColonSpaceChecker["default"])({
      root: root,
      result: result,
      locationChecker: checker.before,
      checkedRuleName: ruleName,
      fix: context.fix ? function (atRule, index) {
        var paramColonIndex = index - (0, _atRuleParamIndex["default"])(atRule);
        fixData = fixData || new Map();
        var colonIndices = fixData.get(atRule) || [];
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var _step$value = _slicedToArray(_step.value, 2),
            ...
            colonIndices = _step$value[1];
          var params = atRule.raws.params ? atRule.raws.params.raw : atRule.params;
          var _iterator2 = _createForOfIteratorHelper(colonIndices.sort(function (a, b) {
              return b - a;
            })),
            _step2;
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              ...
              var beforeColon = params.slice(0, index);
              var afterColon = params.slice(index);
              if (primary === "always") {
