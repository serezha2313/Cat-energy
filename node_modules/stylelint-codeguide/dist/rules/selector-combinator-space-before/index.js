...
var messages = exports.messages = (0, _ruleMessages["default"])(ruleName, {
  expectedBefore: function expectedBefore(combinator) {
    return "Expected single space before \"".concat(combinator, "\"");
  },
  rejectedBefore: function rejectedBefore(combinator) {
    return "Unexpected whitespace before \"".concat(combinator, "\"");
  }
});
