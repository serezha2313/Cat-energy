...
var _selectorListCommaWhitespaceChecker = _interopRequireDefault(require("../selectorListCommaWhitespaceChecker.js"));
...
var ruleName = exports.ruleName = "selector-list-comma-newline-before";
...
var rule = function rule(primary, _secondaryOptions, context) {
  ...
  return function (root, result) {
    ...
    var fixData;
    (0, _selectorListCommaWhitespaceChecker["default"])({
      root: root,
      result: result,
      locationChecker: checker.beforeAllowingIndentation,
      checkedRuleName: ruleName,
      fix: context.fix ? function (ruleNode, index) {
        fixData = fixData || new Map();
        var commaIndices = fixData.get(ruleNode) || [];
        ...
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              ...
              var beforeSelector = selector.slice(0, index);
              var afterSelector = selector.slice(index);
              if (primary.startsWith("always")) {
                var spaceIndex = beforeSelector.search(/\s+$/);
