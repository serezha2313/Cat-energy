...
var _uniteSets = _interopRequireDefault(require("../utils/uniteSets.js"));
...
var htmlTypeSelectors = exports.htmlTypeSelectors = (0, _uniteSets["default"])(deprecatedHtmlTypeSelectors, standardHtmlTypeSelectors);
var mixedCaseSvgTypeSelectors = exports.mixedCaseSvgTypeSelectors = new Set(["altGlyph", "altGlyphDef", "altGlyphItem", "animateColor", "animateMotion", "animateTransform", "clipPath", "feBlend", "feColorMatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feDropShadow", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence", "foreignObject", "glyphRef", "linearGradient", "radialGradient", "textPath"]);
...
var shadowTreePseudoElements = exports.shadowTreePseudoElements = new Set(["part"]);
var webkitScrollbarPseudoElements = exports.webkitScrollbarPseudoElements = new Set(["-webkit-resizer", "-webkit-scrollbar", "-webkit-scrollbar-button", "-webkit-scrollbar-corner", "-webkit-scrollbar-thumb", "-webkit-scrollbar-track", "-webkit-scrollbar-track-piece"]);
...
var pseudoElements = exports.pseudoElements = (0, _uniteSets["default"])(levelOneAndTwoPseudoElements, vendorSpecificPseudoElements, shadowTreePseudoElements, ["backdrop", "content", "cue", "file-selector-button", "grammar-error", "highlight", "marker", "placeholder", "selection", "shadow", "slotted", "spelling-error", "target-text", "view-transition", "view-transition-group", "view-transition-image-pair", "view-transition-new", "view-transition-old"]);
var aNPlusBNotationPseudoClasses = exports.aNPlusBNotationPseudoClasses = new Set(["nth-column", "nth-last-column", "nth-last-of-type", "nth-of-type"]);
var aNPlusBOfSNotationPseudoClasses = exports.aNPlusBOfSNotationPseudoClasses = new Set(["nth-child", "nth-last-child"]);
var atRulePagePseudoClasses = exports.atRulePagePseudoClasses = new Set(["first", "right", "left", "blank"]);
var linguisticPseudoClasses = exports.linguisticPseudoClasses = new Set(["dir", "lang"]);
var logicalCombinationsPseudoClasses = exports.logicalCombinationsPseudoClasses = new Set(["has", "is", "matches", "not", "where"]);
